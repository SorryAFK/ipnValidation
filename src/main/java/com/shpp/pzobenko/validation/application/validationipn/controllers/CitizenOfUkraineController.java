package com.shpp.pzobenko.validation.application.validationipn.controllers;

import com.shpp.pzobenko.validation.application.validationipn.assemblers.CitizenOfUkraineAssembler;
import com.shpp.pzobenko.validation.application.validationipn.dtos.CitizenOfUkraineDTO;
import com.shpp.pzobenko.validation.application.validationipn.services.DtoEntityMapping;
import com.shpp.pzobenko.validation.application.validationipn.services.FindSaveDeleteEditCitizen;
...
@RestController
@RequestMapping("/api/v1/validate-ipn")
@Log4j2
@AllArgsConstructor
